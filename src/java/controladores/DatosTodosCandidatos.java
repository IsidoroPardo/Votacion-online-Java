 ...
 * @author isido
 */
public class DatosTodosCandidatos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                todosCandidatos = bbdd.getTodosCandidatos();
                bbdd.cerrarConexion();
                ...
                if(todosCandidatos.isEmpty()){
                    ...
                    // VER SI SOY ANALISTA PASOS ADICIONALES
                    ...
                    if(rol.equals("analista")){
                        response.sendRedirect("vistas/verCandidatosLocalidad.jsp"); 
                    } 
                    else{
                    response.sendRedirect("vistas/verCandidatos.jsp"); 
                    }
                }
