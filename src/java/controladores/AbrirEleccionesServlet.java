 ...
 * @author isido
 */
public class AbrirEleccionesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                int filas = bbdd.abrirElecciones();
                
                if (filas == 1) {
                        miSesion.setAttribute("mensajeCorrecto", "Apertura de elecciones efectuada");
                        miSesion.setAttribute("ruta", "vistas/altaCandidato.jsp");
                        response.sendRedirect("vistaMensaje.jsp");
                    } else {
                        miSesion.setAttribute("mensajeError", "ERROR: No se ha podido abrir las elecciones");
