    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String ruta = "../imagenes/"+request.getParameter("ruta");
                
                int filas = bbdd.altaPartido(siglas, descp, ruta);
                bbdd.cerrarConexion();
                ...
                if(filas==0){
                    ...
                    miSesion.setAttribute("mensajeCorrecto", "Alta de partido realizada con éxito");
                    miSesion.setAttribute("ruta", "vistas/altaPartido.jsp");
