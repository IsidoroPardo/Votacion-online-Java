 ...
 * @author isido
 */
public class FinalizarEleccionesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                int filas = bbdd.finalizarElecciones();
                
                if (filas == 1) {
                        miSesion.setAttribute("mensajeCorrecto", "Finalización de elecciones efectuada");
                        miSesion.setAttribute("ruta", "vistas/altaCandidato.jsp");
                        response.sendRedirect("vistaMensaje.jsp");
                    } else {
                        miSesion.setAttribute("mensajeError", "ERROR: No se ha podido finalizar las elecciones");
